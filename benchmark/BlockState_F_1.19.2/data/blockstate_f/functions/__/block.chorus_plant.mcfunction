data modify storage blockstate_f: BlockState set value {Name:"minecraft:chorus_plant",Properties:{down:"false",east:"false",north:"false",south:"false",up:"false",west:"false"}}
