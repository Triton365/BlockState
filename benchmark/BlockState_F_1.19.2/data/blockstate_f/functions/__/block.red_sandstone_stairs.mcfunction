data modify storage blockstate_f: BlockState set value {Name:"minecraft:red_sandstone_stairs",Properties:{facing:"east",half:"bottom",shape:"inner_left",waterlogged:"false"}}
