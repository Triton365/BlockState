data modify storage blockstate_f: BlockState set value {Name:"minecraft:spruce_trapdoor",Properties:{facing:"east",half:"bottom",open:"false",powered:"false",waterlogged:"false"}}
