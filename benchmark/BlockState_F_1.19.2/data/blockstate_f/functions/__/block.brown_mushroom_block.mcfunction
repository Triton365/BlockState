data modify storage blockstate_f: BlockState set value {Name:"minecraft:brown_mushroom_block",Properties:{down:"false",east:"false",north:"false",south:"false",up:"false",west:"false"}}
