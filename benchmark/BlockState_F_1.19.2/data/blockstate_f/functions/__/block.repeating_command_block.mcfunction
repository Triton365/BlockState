data modify storage blockstate_f: BlockState set value {Name:"minecraft:repeating_command_block"}
execute if block ~ ~ ~ #blockstate_f:all[conditional=false] run data modify storage blockstate_f: BlockState.Properties.conditional set value "false"
