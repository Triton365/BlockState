data modify storage blockstate_f: BlockState set value {Name:"minecraft:sculk_vein",Properties:{down:"false",east:"false",north:"false",south:"false",up:"false",waterlogged:"false",west:"false"}}
