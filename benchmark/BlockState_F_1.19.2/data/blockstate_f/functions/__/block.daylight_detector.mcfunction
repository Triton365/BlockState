data modify storage blockstate_f: BlockState set value {Name:"minecraft:daylight_detector"}
execute if block ~ ~ ~ #blockstate_f:all[inverted=false] run data modify storage blockstate_f: BlockState.Properties.inverted set value "false"
execute if block ~ ~ ~ #blockstate_f:all[inverted=true] run data modify storage blockstate_f: BlockState.Properties.inverted set value "true"
