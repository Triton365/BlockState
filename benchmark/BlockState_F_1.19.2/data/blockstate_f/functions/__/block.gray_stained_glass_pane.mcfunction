data modify storage blockstate_f: BlockState set value {Name:"minecraft:gray_stained_glass_pane",Properties:{east:"false",north:"false",south:"false",waterlogged:"false",west:"false"}}
