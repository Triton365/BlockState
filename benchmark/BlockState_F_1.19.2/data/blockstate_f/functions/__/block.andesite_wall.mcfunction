data modify storage blockstate_f: BlockState set value {Name:"minecraft:andesite_wall",Properties:{east:"low",north:"low",south:"low",up:"false",waterlogged:"false",west:"low"}}
