data modify storage blockstate_f: BlockState set value {Name:"minecraft:trapped_chest"}
execute if block ~ ~ ~ #blockstate_f:all[type=left] run data modify storage blockstate_f: BlockState.Properties.type set value "left"
