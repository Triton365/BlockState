data modify storage blockstate_f: BlockState set value {Name:"minecraft:end_stone_brick_stairs",Properties:{facing:"east",half:"bottom",shape:"inner_left",waterlogged:"false"}}
