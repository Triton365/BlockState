data modify storage blockstate_f: BlockState set value {Name:"minecraft:dark_oak_fence",Properties:{east:"false",north:"false",south:"false",waterlogged:"false",west:"false"}}
