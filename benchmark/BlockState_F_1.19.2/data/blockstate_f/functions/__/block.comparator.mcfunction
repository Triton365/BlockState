data modify storage blockstate_f: BlockState set value {Name:"minecraft:comparator"}
...
execute if block ~ ~ ~ #blockstate_f:all[mode=compare] run data modify storage blockstate_f: BlockState.Properties.mode set value "compare"
