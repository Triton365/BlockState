data modify storage blockstate_f: BlockState set value {Name:"minecraft:light_gray_stained_glass_pane",Properties:{east:"false",north:"false",south:"false",waterlogged:"false",west:"false"}}
