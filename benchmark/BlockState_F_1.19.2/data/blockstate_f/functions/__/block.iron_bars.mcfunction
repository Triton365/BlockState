data modify storage blockstate_f: BlockState set value {Name:"minecraft:iron_bars",Properties:{east:"false",north:"false",south:"false",waterlogged:"false",west:"false"}}
