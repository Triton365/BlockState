data modify storage blockstate_f: BlockState set value {Name:"minecraft:jungle_trapdoor",Properties:{facing:"east",half:"bottom",open:"false",powered:"false",waterlogged:"false"}}
