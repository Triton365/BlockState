data modify storage blockstate_f: BlockState set value {Name:"minecraft:birch_fence",Properties:{east:"false",north:"false",south:"false",waterlogged:"false",west:"false"}}
