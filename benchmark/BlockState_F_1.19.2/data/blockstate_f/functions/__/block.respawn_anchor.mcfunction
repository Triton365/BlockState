data modify storage blockstate_f: BlockState set value {Name:"minecraft:respawn_anchor"}
execute if block ~ ~ ~ #blockstate_f:all[charges=0] run data modify storage blockstate_f: BlockState.Properties.charges set value "0"
