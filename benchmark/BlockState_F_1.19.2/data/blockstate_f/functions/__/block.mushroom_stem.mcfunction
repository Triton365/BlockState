data modify storage blockstate_f: BlockState set value {Name:"minecraft:mushroom_stem",Properties:{down:"false",east:"false",north:"false",south:"false",up:"false",west:"false"}}
