data modify storage blockstate_f: BlockState set value {Name:"minecraft:glow_lichen",Properties:{down:"false",east:"false",north:"false",south:"false",up:"false",waterlogged:"false",west:"false"}}
