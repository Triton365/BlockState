data modify storage blockstate_f: BlockState set value {Name:"minecraft:note_block"}
execute if block ~ ~ ~ #blockstate_f:all[instrument=banjo] run data modify storage blockstate_f: BlockState.Properties.instrument set value "banjo"
...
execute if predicate blockstate_f:state.note.0..4 run function blockstate_f:__/state.note.0.1.2.3.4
