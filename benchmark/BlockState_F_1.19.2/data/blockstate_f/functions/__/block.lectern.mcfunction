data modify storage blockstate_f: BlockState set value {Name:"minecraft:lectern"}
...
execute if block ~ ~ ~ #blockstate_f:all[has_book=false] run data modify storage blockstate_f: BlockState.Properties.has_book set value "false"
