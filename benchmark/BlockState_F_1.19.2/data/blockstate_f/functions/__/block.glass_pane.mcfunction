data modify storage blockstate_f: BlockState set value {Name:"minecraft:glass_pane",Properties:{east:"false",north:"false",south:"false",waterlogged:"false",west:"false"}}
