data modify storage blockstate_f: BlockState set value {Name:"minecraft:smooth_quartz_stairs",Properties:{facing:"east",half:"bottom",shape:"inner_left",waterlogged:"false"}}
