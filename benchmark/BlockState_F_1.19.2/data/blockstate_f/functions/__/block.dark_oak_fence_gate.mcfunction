data modify storage blockstate_f: BlockState set value {Name:"minecraft:dark_oak_fence_gate",Properties:{facing:"east",in_wall:"false",open:"false",powered:"false"}}
