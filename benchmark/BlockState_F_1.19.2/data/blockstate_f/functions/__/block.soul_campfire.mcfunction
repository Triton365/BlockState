data modify storage blockstate_f: BlockState set value {Name:"minecraft:soul_campfire",Properties:{facing:"east",lit:"false",signal_fire:"false",waterlogged:"false"}}
