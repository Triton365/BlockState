data modify storage blockstate_f: BlockState set value {Name:"minecraft:spruce_door",Properties:{facing:"east",half:"lower",hinge:"left",open:"false",powered:"false"}}
