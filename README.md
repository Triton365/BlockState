...
## 다운로드
v1.0.0: https://github.com/Triton365/BlockState/releases/download/v1.0.0/BlockState_v1.0.0.zip   
<br><br>
...
- 해당 블록의 모든 NBT를 `TileEntityData`로 가져옵니다. 그게 블록 엔티티인지 판단하는 과정은 없습니다.   
